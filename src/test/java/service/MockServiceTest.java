...
public class MockServiceTest {
    ...
    @Test
    public void 챔피언이름에_상관없이_무조건_베인을_리턴한다() {
        Champion champion = mock(Champion.class);
        champion.setName("카이사");
        champion.setPosition("탑");
        //System.out.println("Champion : " + champion.getName()); -> 값 없음
    ...
    public void shouldSetMidPositionUseVerify(){
        ...
        verify(champion,times(1)).setName("야스오");
    }
    ...
    @Test
    public void shouldTwiceInvocationForGetChampionName(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void shouldNotSetChampionName(){
        Champion champion = mock(Champion.class);
        //champion.setName("시비르");
        champion.setPosition("바텀");
        champion.setHasSkinCount(6);
    ...
    @Test
    public void shouldOnceInvocationIn200msForChampionGetName() {
        Champion champion = mock(Champion.class);
        champion.setName("드페");
        champion.setPosition("미드");
    ...
    @Test
    public void numberOfChampionList() {
    ...
    public void testSkinCountAndInvocationOneTimeWhenFindChampion() {
        ...
        assertThat(mockService.findByName("르블링").getHasSkinCount(), is(5));
        verify(mockRepository, times(1)).findByName(anyString());
    }
    ...
    public void testInvocationCountWhenGEtChampionList() {
        ...
        champions.add(new Champion("루시안", "바텀", 5));
        champions.add(new Champion("리산드라", "미드", 4));
        champions.add(new Champion("르블링", "서폿", 3));
