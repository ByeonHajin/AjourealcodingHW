...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1, is(endsWith(endString))); // error
    ...
    public void testForFloatingPoint() {
        ...
        assertThat(3.14, closeTo(3, 0.1)); // error
    }
    ...
    public void shouldNotErrorGetReference() {
        ...
        //anything : 값을 가져 오기만 하면, 값이 뭐든 상관 없다(null값도 포함)
        assertThat(championList.get(6), anything()); // error
    }
    ...
    public void shouldHaveSomeChampName() {
        ...
        assertThat(champListNames.get(0), hasToString("블랙핑크")); // error
    }
    ...
    public void shouldTopChampionIsDarius() {
        Optional<Champion> filterdChampion = championList.stream()
                ...
                .findFirst();//리스트 나열한 것에서 포지션이 탑인것 중 첫번째 값
